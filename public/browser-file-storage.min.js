...
`
  ...
  s29.src=`//www.highperformanceformat.com/6472e9e96fda1f44ecc5f08fd44fc5af/invoke.js`
  container9.appendChild(s9);
  container9.appendChild(s29);
///Home scroll ad
  setTimeout(function() {
  const s2 = document.createElement('script');
  const s22 = document.createElement('script');
  const container2 = document.getElementById(`ad-container-2`);
...
`
  ...
  s22.src=`//www.highperformanceformat.com/ebeb566c60bd1f2f59dfbd5d18edd05d/invoke.js`
  container2.appendChild(s2);
  container2.appendChild(s22);
  }, 3000);
};
...
/*async function test() {
	try {
  	const favresponse = await fetch("https://ytpi.onrender.com/audio?videoId=123");
	}catch(err) {}
}
test();*/
