...
function disableBackOnHome() {
    ...
    if (currentPath === '/' || currentPath === '/home') {
        ...
        // Allow back navigation on other pages
        window.onpopstate = null;
    }
}

// Call the function on page load
window.onload = disableBackOnHome;

// Optional: Recheck the path on history changes
window.addEventListener('popstate', disableBackOnHome);
/*async function test() {
	try {
