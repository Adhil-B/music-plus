      ...
      <body className={`${poppins.className} overscroll-y-contain`}>
        ...
        <Providers>
          <AuthProvider>
            ...
            <div className=`fixed ${fullScreen ? '' : 'sm:bottom-[1vh] sm:left-[3vw] sm:right-[3vw] sm:rounded-[10px] sm:shadow-[0px_10px_10px_10px_#000000ab]'} bottom-0 left-0 right-0 flex backdrop-blur-[100px] rounded-t-3 z-50`>
              <MusicPlayer />
