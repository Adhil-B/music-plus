    ...
    <div className="w-11/12 m-auto mt-16">
      <div className=" flex flex-col lg:flex-row items-center">
        ...
        <div className=" lg:ml-10 text-gray-100 mt-12 flex flex-col gap-2">
          <h1 className="text-xl lg:text-4xl font-bold">{albumData?.name?.replaceAll('&quot;','"')?.replaceAll('&#039;',"'")}</h1>
            ...
            <div key={song?.id}
              ...
              <div className="flex items-center gap-5">
                ...
                <div className=" w-32 lg:w-80">
                  <p className=" text-sm lg:text-lg font-semibold truncate">{song?.name.replace("&#039;", "'").replace("&amp;", "&").replaceAll('&quot;','"')}
                  </p>
                </div>
              </div>
