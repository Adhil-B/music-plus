    ...
    <div>
         <div
            onClick={() => {
             ...
             className={`flex w-40 md:w-80 items-center mt-5 cursor-pointer group border-b-[2px] sm:border-b-[0px] border-[#ffffff38] sm:border-[#ffffff00] justify-between ${activeSong?.id === song?.id && " text-[#00e6e6]"}`}>
