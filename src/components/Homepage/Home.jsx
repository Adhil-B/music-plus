...
const Home = () => {
  ...
  return (
    <div>
      <OnlineStatus />
      <h1 className='sal text-[9vw] sm:text-4xl font-bold mx-2 m-9 text-white flex gap-2'>"{salutation}  <GiMusicalNotes />"</h1>
...
{/* Quick Picks */}
      ...
      <div className="my-4 lg:mt-14">
        ...
        <div className="hideScrollBar grid lg:grid-cols-2 gap-x-10 max-h-[19rem] sm:max-h-96 lg:max-h-full lg:overflow-y-auto overflow-y-scroll">
          {
            loading ? (
      ...
      <ScriptComponent adkey={`ebeb566c60bd1f2f59dfbd5d18edd05d`} height={320} width={50} adno={1} />
