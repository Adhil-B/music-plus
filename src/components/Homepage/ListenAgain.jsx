      ...
      {/* Listen Again */}
      {
        songHistory?.length > 0 && (
          <div>
            ...
            <div className="overflow-y-scroll hideScrollBar max-h-[170px] bg-[hsla(0,0%,100%,.05)] pt-[3px] pr-[15px] pb-[15px] pl-[20px] rounded-lg grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-x-10">
              {
