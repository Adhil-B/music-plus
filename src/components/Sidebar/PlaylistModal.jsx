                ...
                <div onClick={(e) => e.stopPropagation() } className='bg-[#020813a1] border-[1px] border-[#ffffff12] bg-opacity-80 backdrop-blur-[10px] rounded-lg w-[auto]'>
                    ...
                    <div className='flex flex-col justify-center items-center'>
                        <div className=" flex gap-4 items-end mb-3">
                            ...
                            <input onFocus={handleFocus} onBlur={handleBlur} onChange={handleChange} value={name} name='name' type="text" placeholder="Playlist Name" required className='my-[5px] py-[10px] pl-[15px] border-[#ffffff12] border-[1px] rounded-[10px] bg-[#020813a1] mx-[20px] appearance-none bg-[#f5deb300] bg-opacity-100 backdrop-blur-sm focus:outline-none text-base lg:text-lg' />
                        </div>
