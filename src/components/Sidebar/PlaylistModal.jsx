    ...
    return (show &&
        <div>
            <div onClick={() => setShow(false)} className='fixed bg-black bg-opacity-50 top-0 left-0 w-full h-full z-50 flex justify-center items-center text-white'>
                <div onClick={(e) => e.stopPropagation() } className='bg-[#020813a1] border-[1px] border-[#ffffff12] bg-opacity-80 backdrop-blur-[10px] rounded-lg w-[auto]'>
                    <div className='flex justify-between items-center px-[20px] pb-[10px]'>
                    ...
                    <div className='flex flex-col justify-center items-center'>
                        <div className=" flex gap-4 items-end mb-3">
                            ...
                            <input onFocus={handleFocus} onBlur={handleBlur} onChange={handleChange} value={name} name='name' type="text" placeholder="Playlist Name" required className='my-[5px] py-[10px] pl-[15px] border-[#ffffff12] border-[1px] rounded-[10px] bg-[#020813a1] mx-[20px] appearance-none bg-[#f5deb300] bg-opacity-100 backdrop-blur-sm border-b border-white focus:outline-none text-base lg:text-lg' />
                        </div>
                            <button onClick={handelCreate} className='group-hover:text-[#00e6e6] text-sm group font-semibold mb-7 flex gap-2 border-[1.5px] border-white rounded-lg px-[15px] items-center py-[10px] border-[1px] border-[#ffffff12]'>
                                {
