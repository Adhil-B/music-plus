                ...
                <div onClick={(e) => e.stopPropagation() } className='bg-white/5 bg-opacity-80 backdrop-blur-sm rounded-lg w-[500px]'>
                    ...
                    <div className='flex flex-col justify-center items-center'>
                        <div className=" flex gap-4 items-end mb-3">
                            ...
                            <input onFocus={handleFocus} onBlur={handleBlur} onChange={handleChange} value={name} name='name' type="text" placeholder="Playlist Name" required className='mr-[20px] appearance-none bg-[#f5deb300] bg-opacity-100 backdrop-blur-sm border-b border-white focus:outline-none text-base lg:text-lg' />
                        </div>
