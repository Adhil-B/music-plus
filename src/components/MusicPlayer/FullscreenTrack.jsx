      ...
      <div className="flex flex-col items-center lg:w-[50%] h-[55vh] sm:h-auto mt-[15vh] sm:mt-auto" >
        <div
         ...
         className=" h-80 w-80 lg:h-[60vh] lg:w-[60vh] sm:mt-5  ">
          <img src={activeSong?.image?.[2].link.replace('https://i.ytimg.com','https://api.allorigins.win/raw?url=https://i.ytimg.com')} alt="cover art" className="h-[100%] object-cover rounded-lg" />
        </div>
