...
const FullscreenTrack = ({ fullScreen, activeSong, handlePrevSong, handleNextSong }) => {
  ...
  return (
    <div className={`${fullScreen ? 'block' : 'hidden'} w-[100%] h-[77vh] flex lg:flex-row lg:w-[100vw] mx-auto flex-col  lg:justify-between mt-10`}>
      ...
      <div onClick={(e) => e.stopPropagation()} className=" w-[50%] mr-[8vw] flex-col items-center lg:flex hidden">
