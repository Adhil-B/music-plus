  ...
  return (
    ...
    <form onSubmit={handleSubmit} autoComplete="off" className={`${isTyping ? 'motion-preset-slide-left motion-duration-100 shadow-[0px_0px_0px_5000px_#00000090] sm:shadow-[0px_0px_0px_0px_#00000090] bg-[#00000090] sm:bg-transparent' : ''} z-[35] p-2 text-gray-400 relative focus-within:text-gray-600`}>
      ...
      <div className={`${isTyping ? '!w-[88vw] sm:!w-auto':''} asearch z-[91] flex flex-row justify-start items-center`}>
       ...
       <div className={`${isTyping ? 'motion-preset-slide-down motion-delay-100 motion-duration-100 !w-[88vw] sm:!w-auto':'hidden'} ${suggestion.length < 1 && searchH.length < 1 ? 'hidden':''} !backdrop-blur-[8px] !pl-[0px] !mt-[5px] !rounded-[30px] !h-auto fixed t-25vh z-[39] asearch w-[87%] sm:w-[320px] p-[10px] `}>
