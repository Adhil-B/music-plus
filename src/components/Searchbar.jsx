...
/*<Autocomplete
        ...
        */
  return (
    <form onSubmit={handleSubmit} autoComplete="off" className={`${isTyping ? 'shadow-[0px_0px_0px_900px_#00000090] bg-[#00000090]' : ''} p-2 text-gray-400 relative focus-within:text-gray-600`}>
